...
public class TestQuality {
	...
	static double qualityMax;
	static double qualityMin = 200;
	...
	public void runInstance(List<Point> points) {
		...
		double quality = areaRectangle / areaPolygon * 100 - 100;
		qualitySum += quality;
	...
	public static void main(String[] args) {
		...
		System.out.println(qualityMin + " " + qualitySum / instanceCount + " " + qualityMax);
	}
}
